    ...
    <View style={styles.invoiceItem}>
      ...
      <View style={styles.itemRow}>
        ...
        <View style={{ alignItems: "flex-end" }}>
          <Text style={styles.itemValue}>
            {item.amount.toFixed(2)} {typesCrypto[item.cryptoType]}
          </Text>

          <Text style={styles.usdValue}>{item.amount.toFixed(2)} USD</Text>
        </View>
      </View>
      ...
      <View style={styles.itemRow}>
        ...
        <View style={{ alignItems: "flex-end" }}>
          ...
          {item.expiresAt && (
            <Text style={styles.usdValue}>{formatDate(item.expiresAt)}</Text>
          )}
        </View>
      </View>
      <View style={styles.itemRow}>
        <Text style={styles.itemTitle}>Customer</Text>
        <Text style={styles.itemValue}>{item.customer || "N/A"}</Text>
      </View>
      ...
      <View style={styles.itemRow}>
        ...
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          ...
          <Text style={styles.itemValue}>{names[item.status]}</Text>
        </View>
      </View>
    </View>
  );
